...
- End-to-end REST demo: [`dummy-loom`](https://github.com/MassiveDataScope/dummy-loom).
- End-to-end ETL demo: [`dummy-loom-etl`](https://github.com/MassiveDataScope/dummy-loom-etl) — full Polars and Spark pipeline examples.
...
[`dummy-loom`](https://github.com/MassiveDataScope/dummy-loom).
...
For a full Polars + Spark + Delta Lake example see [`dummy-loom-etl`](https://github.com/MassiveDataScope/dummy-loom-etl).
...
The full benchmark suite is available in [`dummy-loom`](https://github.com/MassiveDataScope/dummy-loom).
