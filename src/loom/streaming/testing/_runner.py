"""Testing runner for Loom streaming flows."""
...
class StreamingTestRunner:
    ...
    the source and sinks for Bytewax testing primitives. Tests can append input
    records, opt into capturing explicit error branches, and inspect captured
    ...
    def given_input(self, *items: Any) -> StreamingTestRunner:
    ...
    def run(self) -> None:
        """Execute the compiled dataflow with testing source/sinks."""
