...
class PlanBuilder:
    """Build a compiled plan from a validated flow."""

    def build(self, flow: StreamFlow[Any, Any], runtime_config: DictConfig) -> CompiledPlan:
        """Build a compiled plan for *flow*."""
