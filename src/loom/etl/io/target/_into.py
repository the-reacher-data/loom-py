...
Public API — import from :mod:`loom.etl.io.target` or :mod:`loom.etl.io`.
...
class IntoFile:
    ...
    def _to_spec(self) -> Any:
        from loom.etl.io.target._file import FileSpec  # local — avoids circular import
...
class IntoTemp:
    ...
    * **Spark** — Parquet directory via ``df.write.parquet()`` and
    ...
    def _to_spec(self) -> Any:
        from loom.etl.io.target._temp import (
            TempFanInSpec,
            TempSpec,
