...
Internal module — import from :mod:`loom.etl.io.source`.
...
class JsonColumnSpec:
    ...
    Produced by :meth:`~loom.etl.io.source.FromTable.parse_json` and
    :meth:`~loom.etl.io.source.FromFile.parse_json`.
...
class TableSourceSpec:
    ...
    Produced by :meth:`~loom.etl.io.source.FromTable._to_spec`.
...
class FileSourceSpec:
    ...
    Produced by :meth:`~loom.etl.io.source.FromFile._to_spec`.
    Consumed by the compiler and executor — never exposed in user code.
