...
_ALLOWED: dict[tuple[str, str], int] = {
    ...
    ("ai/fastapi/endpoints.py", "msgspec.to_builtins"): 1,
    ...
    ("core/cache/gateway.py", "msgspec.convert"): 2,
    ...
    ("core/cache/result_codec.py", "msgspec.convert"): 1,
    ("core/cache/result_codec.py", "msgspec.to_builtins"): 2,
    ("core/cache/result_codec.py", "pydantic.TypeAdapter"): 1,
